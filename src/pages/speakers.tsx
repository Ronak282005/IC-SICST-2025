...
const Speakers = () => {
  return (
    <>
      ...
      <main className="bg-gradient-to-b from-blue-50 to-white px-4 sm:px-6 lg:px-8 min-h-screen">
                  ...
                  <div className="relative w-full h-[250px] sm:h-[300px] lg:h-[400px] bg-gray-100">
                    ...
                    <div className="absolute bottom-2 sm:bottom-3 lg:bottom-4 left-2 sm:left-3 lg:left-4 transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                      {!speaker.national ? (
                        ...
                        <div className="inline-block bg-white bg-opacity-90 backdrop-blur-sm rounded-full px-3 sm:px-4 py-1.5 sm:py-2">
